...
class SwinUnet2D(nn.Module):
    ...
    def forward(self, img):
        ...
        assert x_s % (x_ws * 32) == 0, f'The size of the x-axis must be divisible by x_window_size × 32'
        assert y_s % (y_ws * 32) == 0, f'The size of the y-axis must be divisible by x_window_size × 32'
